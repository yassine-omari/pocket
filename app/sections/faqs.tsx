  ...
  return (
    <Section className="border-t border-gray-200">
      <Div>
        ...
        <div className="mt-16 grid max-w-2xl grid-cols-1 gap-8 sm:mt-20 lg:max-w-none lg:grid-cols-3">
            ...
            <div key={index} className="space-y-10">
              {column.map((faq) => (
                <div key={faq.question}>
                  ...
                  <p className="mt-4 text-sm leading-6 text-gray-700">{faq.answer}</p>
                </div>
              ))}
            </div>
          ))}
